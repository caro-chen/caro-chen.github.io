...
jQuery(document).ready(function($){
    ...
    if ($(this).scrollTop() > 100) {
        ...
        $('.topnav a').css("color", "black").css("transition","0.3s ease-in-out");
        ...
        $('.active').css("border-bottom", "2px solid white").css("transition","0.3s ease-in-out");
        $('.topnav a').css("color", "white").css("transition","0.3s ease-in-out");
    }
    });
});
